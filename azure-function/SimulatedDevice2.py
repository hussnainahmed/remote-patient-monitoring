...
CONNECTION_STRING = "HostName=rpm-pbi-iothub.azure-devices.net;DeviceId=rpm-pbi-dev-2;SharedAccessKey=0kF/krNqT6ubLZO9BMQ6suGMc0Za3TQFmalB2v+S7wc="
    ...
    try:
        ...
        while True:
            ...
            if int(time.time()) % 300 > 10:
                ...
                message = Message(msg_txt_formatted_non_cont)
